...
export default function FilterInput({
  ...
  return (
    ...
    >
      ...
      <div className="w-full bg-white flex flex-col border border-gray-300 p-2 rounded-md cursor-pointer relative ">
        <input
          className="text-xs bg-white font-medium text-[#040404] outline-none placeholder-[#9295A3] placeholder:capitalize"
          type={
